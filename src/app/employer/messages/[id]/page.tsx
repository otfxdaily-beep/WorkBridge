...
export default async function EmployerMessageThreadPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <Container className="max-w-2xl py-10">
      <Link href="/employer/messages" className="text-sm text-brand-600 hover:underline">
        &larr; Messages
      </Link>
